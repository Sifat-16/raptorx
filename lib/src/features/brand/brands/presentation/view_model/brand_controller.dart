...
final brandProvider = StateNotifierProvider<BrandController, BrandGeneric>(
    (ref) => BrandController(ref));
      ...
      if (await brandedAppsDirectory.exists()) {
        ...
        brandedAppsDirectory.listSync().forEach((entity) {
          if (entity is Directory) {
            subdirectories.add(BrandModel(
                brandName: entity.path.split('/').last,
                brandLocation: entity.path,
                brandImage:
                    "${entity.path}/android/app/src/main/ic_launcher-playstore.png"));
          }
        });
