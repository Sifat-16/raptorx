...
final settingsProvider =
    StateNotifierProvider<SettingsController, SettingsGeneric>(
...
class SettingsController extends StateNotifier<SettingsGeneric> {
  ...
  onSelectSourceCode() async {
    ...
    if (directoryPath != null) {
      String? sourceCode = await ref
          .read(buildConfigProvider.notifier)
          .updateSourceCodeDirectory(sourceCode: directoryPath);
      if (sourceCode != null) {
