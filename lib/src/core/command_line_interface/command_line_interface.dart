        ...
        children: [
          ...
          Expanded(
            child: TerminalView(
              ...
              controller: ref.read(processProvider(widget.pid).notifier).terminalController,
              autofocus: true,
              backgroundOpacity: 0.7,
              onSecondaryTapDown: ref.read(processProvider(widget.pid).notifier).onSecondaryTapDown,
            ),
          ),
        ],
      ),
